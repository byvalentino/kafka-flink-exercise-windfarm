...
-- Step 1: Create a processing-time helper view from turbine_signals.
-- Include at least: farm_id, active_power_kw, wind_speed_m_s,
-- grid_frequency_hz, status, and PROCTIME() AS proc_time.

-- Step 2: Insert 30-second farm-level aggregates into power_grid_stats.
-- Use TUMBLE(TABLE turbine_signals_proc, DESCRIPTOR(proc_time), INTERVAL '30' SECOND)
-- and group by farm_id, window_start, window_end.
